...
const NewNavBars = () => {
    ...
    return (
        <nav className="flex items-center justify-center pb-4 bg-gradient-to-r from-[#ECF2F6] to-white sticky top-0 z-50 transition-all duration-700"
            style={{
                boxShadow: "1px 1px 10px 1px rgba(180, 180, 180, 10)"
            }}
        >
            <div className="flex w-11/12 items-center justify-between pt-[14px]">
                {/* logo */}
                <Link to="/">
                    <img className=" pl-[50px]" src={logo} alt=""/>
                </Link>
